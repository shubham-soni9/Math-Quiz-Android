...
public class ConfigDefinition {
    ...
    public int getTotalVisibleView() {
        return this.totalVisibleView;
    }

    public void setTotalVisibleView(int totalVisibleView) {
        this.totalVisibleView = totalVisibleView;
    }
